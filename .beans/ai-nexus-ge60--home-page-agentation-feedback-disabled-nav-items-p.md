...
Disable Gift Pawrrtal and Get apps dropdown items visually; slow composer placeholder rotation.



## Summary of Changes

- `frontend/components/nav-user.tsx`: Set `disabled` on **Get apps and extensions** and **Gift Pawrrtal** dropdown items so they render as non-interactive and muted.
