...
Port linter rules, assists, CSS/test overrides from ThirdEar react-native/biome.json; bump Biome to 2.4.10; preserve ai-nexus vendor/layout overrides.
...
- Preserved AI Nexus overrides (globals.css noImportantStyles, vendor disables, layout.tsx dangerouslySetInnerHTML); added overrides for commit/dev tooling scripts, .agents/**.
