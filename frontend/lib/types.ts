...
export interface AgnoMessage {
	...
	/**
	 * Inline images generated by the `generate_image` tool during this turn.
	 * Each entry carries a base64-encoded PNG that the frontend renders without
	 * a separate HTTP fetch.
	 */
	generatedImages?: import('@/features/chat/types').ChatImagePayload[];
}
