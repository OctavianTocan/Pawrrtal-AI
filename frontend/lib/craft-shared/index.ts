 ...
 *   import { getCredentialManager } from './credentials-stubs';
 *   import { CraftMcpClient } from '@craft-agent/shared/mcp';
 *   import { debug } from './utils';
 *   import { loadSource, createSource, getSourceCredentialManager } from './sources';
 *   import { createWorkspace, loadWorkspace } from './workspaces';
 *
 * Available modules:
