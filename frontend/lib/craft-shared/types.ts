...
export { PERMISSION_MODE_CONFIG } from './agent/mode-types';

// Thinking level types
import type { ThinkingLevel } from './agent/thinking-levels';
export type { ThinkingLevel };
export { THINKING_LEVELS, DEFAULT_THINKING_LEVEL } from './agent/thinking-levels';
...
import type { AuthState, SetupNeeds } from './auth-stubs';
import type { AuthType } from './config/types';
export type { AuthState, SetupNeeds, AuthType };

// Credential health types
import type { CredentialHealthStatus, CredentialHealthIssue, CredentialHealthIssueType } from './credentials-stubs';
...
import type { LoadedSource, FolderSourceConfig, SourceConnectionStatus } from './sources/types';
export type { LoadedSource, FolderSourceConfig, SourceConnectionStatus };

// Skill types
import type { LoadedSkill, SkillMetadata } from './skills/types';
...
import type { NetworkProxySettings } from './config/types';
...
import type { Workspace, SessionMetadata, StoredAttachment as StoredAttachmentType } from './core';
...
export interface ElectronAPI {
  ...
  storeAttachment(sessionId: string, attachment: FileAttachment): Promise<import('@craft-agent/core/types').StoredAttachment>
  ...
  getSourcePermissionsConfig(workspaceId: string, sourceSlug: string): Promise<import('./agent/mode-types').PermissionsConfigFile | null>
  getWorkspacePermissionsConfig(workspaceId: string): Promise<import('./agent/mode-types').PermissionsConfigFile | null>
  getDefaultPermissionsConfig(): Promise<{ config: import('./agent/mode-types').PermissionsConfigFile | null; path: string }>
  ...
  listStatuses(workspaceId: string): Promise<import('./statuses/types').StatusConfig[]>
  ...
  listLabels(workspaceId: string): Promise<import('./labels').LabelConfig[]>
  createLabel(workspaceId: string, input: import('./labels').CreateLabelInput): Promise<import('./labels').LabelConfig>
  ...
  listViews(workspaceId: string): Promise<import('./views').ViewConfig[]>
  saveViews(workspaceId: string, views: import('./views').ViewConfig[]): Promise<void>
