...
import { expandPath, toPortablePath } from '../utils/paths';
import { atomicWriteFileSync, readJsonFileSync } from '../utils/files';
import { getDefaultStatusConfig, saveStatusConfig, ensureDefaultIconFiles } from '../statuses/storage';
import { getDefaultLabelConfig, saveLabelConfig } from '../labels/storage';
import { loadConfigDefaults } from '../config/storage';
import { parsePermissionMode, PERMISSION_MODE_ORDER } from '../agent/mode-types';
import { normalizeThinkingLevel } from '../agent/thinking-levels';
import type {
  WorkspaceConfig,
