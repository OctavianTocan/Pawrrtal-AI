...
type SharedCredentialInputMode =
  | 'bearer'
  | 'basic'
  | 'header'
  | 'query'
...
interface SharedCredentialAuthRequest extends SharedAuthRequest {
  type: 'credential'
  sessionId: string
  mode: SharedCredentialInputMode
  sourceName: string
  sourceUrl?: string
  hint?: string
  headerName?: string
...
export { generateMessageId } from '../core'
