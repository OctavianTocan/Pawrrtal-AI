...
import type { AutomationCondition, TimeCondition, StateCondition, LogicalCondition } from './types';
import { MAX_CONDITION_DEPTH_EXCLUSIVE } from './conditions-constants';
