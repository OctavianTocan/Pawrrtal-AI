...
import { isOAuthSource, type LoadedSource } from './types';
import type { SourceCredentialManager } from './credential-manager';
import { markSourceAuthenticated } from './storage';
