...
import type { ContentBadge } from '@/lib/craft-core-stubs'
import type { MentionItemType } from '@/components/ui/mention-menu'
import type { LoadedSkill, LoadedSource } from '@/lib/craft-shared/types'
import { AGENTS_PLUGIN_NAME } from '@/lib/craft-shared/skills/types'
...
import { parseMentions, stripAllMentions, type ParsedMentions } from '@/lib/craft-shared/mentions'
