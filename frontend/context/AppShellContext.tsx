...
import type { ChatDisplayHandle } from '@/components/shell/ChatDisplay'
import type {
  Session,
  Workspace,
  FileAttachment,
...
export interface AppShellContextType {
  ...
  onSendMessage: (sessionId: string, message: string, attachments?: FileAttachment[], skillSlugs?: string[], badges?: import('@/lib/craft-core-stubs').ContentBadge[]) => void
