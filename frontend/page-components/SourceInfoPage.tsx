...
import { SourceMenu } from '@/components/shell/SourceMenu'
...
import type { LoadedSource, McpToolWithPermission } from '@/lib/craft-shared/types'
import type { PermissionsConfigFile } from '@/lib/craft-shared/agent/mode-types'
