...
import type { CredentialHealthStatus, CredentialHealthIssue } from '@/lib/craft-shared/types'
import { Spinner, FullscreenOverlayBase } from '@/components/craft-ui'
import { useSetAtom } from 'jotai'
import { fullscreenOverlayOpenAtom } from '@/atoms/overlay'
import { motion, AnimatePresence } from 'motion/react'
import type { LlmConnectionWithStatus, ThinkingLevel, WorkspaceSettings, Workspace } from '@/lib/craft-shared/types'
import { DEFAULT_THINKING_LEVEL, THINKING_LEVELS } from '@/lib/craft-shared/agent/thinking-levels'
...
import { getModelShortName, type ModelDefinition } from '@/lib/craft-shared/config/models'
import { getModelsForProviderType, type CustomEndpointApi } from '@/lib/craft-shared/config/llm-connections'
...
export default function AiSettingsPage() {
  ...
  const handleDefaultModelChange = useCallback(async (model: string) => {
    ...
    await window.electronAPI.saveLlmConnection(connectionData as import('@/lib/craft-shared/types').LlmConnection)
