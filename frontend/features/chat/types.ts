 ...
 * {@link ChatStreamEvent}; the container collapses the stream into an
 * `AgnoMessage` (from `@/lib/types`) that the UI can render — reasoning
 * panel above the body, chronologically-ordered tool rows, source chips,
 * and a reply-action toolbar.
 *
