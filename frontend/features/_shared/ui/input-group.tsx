...
function InputGroup({ className, ...props }: React.ComponentProps<'div'>) {
	return (
		// biome-ignore lint/a11y/useSemanticElements: <fieldset> would constrain children styling (default margin/padding/border reset across browsers) and break the addon layout; the div uses role=group + ARIA labels on its inputs.
		<div
...
function InputGroupAddon({
	...
	return (
		// biome-ignore lint/a11y/useSemanticElements: addon is a non-interactive grouping container that delegates focus to its sibling input; <fieldset> would inject default chrome and break the cn variants.
		<div
			role="group"
