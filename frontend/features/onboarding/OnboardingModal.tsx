...
export function OnboardingModal({
  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      <DialogContent className="top-0 left-0 h-[100dvh] max-h-none w-screen max-w-none translate-x-0 translate-y-0 overflow-hidden rounded-none border-0 bg-[#080d12] p-0 shadow-none ring-0 sm:max-w-none sm:p-0 [&>button]:top-6 [&>button]:right-6 [&>button]:z-30 [&>button]:rounded-xl [&>button]:bg-white/[0.035] [&>button]:text-white/62 [&>button]:ring-1 [&>button]:ring-white/10 [&>button]:hover:bg-white/[0.07] [&>button]:hover:text-white">
        {/*
