...
import { PERMISSION_MODE_CONFIG, type PermissionMode } from '@/lib/craft-shared/agent/mode-types'
...
import { flattenLabels, parseLabelEntry, formatLabelEntry } from '@/lib/craft-shared/labels'
