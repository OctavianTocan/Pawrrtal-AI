...
import { extractLabelId } from '@/lib/craft-shared/labels'
import type { SessionStatusId } from '@/config/session-status-config'
import { SourceInfoPage, ChatPage } from '@/page-components'
import SkillInfoPage from '@/page-components/SkillInfoPage'
import { getSettingsPageComponent } from '@/page-components/settings/settings-pages'
...
export interface MainContentPanelProps {
   ...
   */
  navStateOverride?: import('@/lib/craft-shared/types').NavigationState | null
}
