...
import { Tooltip, TooltipTrigger, TooltipContent, DocumentFormattedMarkdownOverlay } from "@/components/craft-ui"
import {
  DropdownMenu,
  DropdownMenuTrigger,
  DropdownMenuSub,
...
import type { Session, Workspace, FileAttachment, PermissionRequest, LoadedSource, LoadedSkill, PermissionMode, SourceFilter, AutomationFilter } from '@/lib/craft-shared/types'
...
import { buildLabelTree, getDescendantIds, getLabelDisplayName, flattenLabels, extractLabelId, findLabelById } from "@/lib/craft-shared/labels"
import type { LabelConfig, LabelTreeNode } from "@/lib/craft-shared/labels"
import { resolveEntityColor } from "@/lib/craft-shared/colors"
...
import type { SettingsSubpage } from '@/lib/craft-shared/types'
...
import SettingsNavigator from "@/page-components/settings/SettingsNavigator"
import {
  PANEL_GAP,
  PANEL_EDGE_INSET,
...
import { dispatchFocusInputEvent } from '@/components/input/focus-input-events'
...
interface AppShellProps {
  ...
  /** Optional children to render within the shell */
...
function AppShellContent({
  ...
  const chatDisplayRef = React.useRef<ChatDisplayHandle>(null) as React.RefObject<ChatDisplayHandle>
