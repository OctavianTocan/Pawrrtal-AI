		...
		<div className="shrink-0 px-2 pt-2 pb-1.5 border-b border-border/50">
			<div className="relative rounded-[8px] shadow-minimal bg-muted/50 has-[:focus-visible]:bg-background">
				...
				<input
					...
					className="w-full h-8 pl-8 pr-8 text-sm bg-transparent border-0 rounded-[8px] outline-none focus-visible:ring-2 focus-visible:ring-ring placeholder:text-muted-foreground/50"
				/>
				{searchQuery ? (
					<button
						type="button"
