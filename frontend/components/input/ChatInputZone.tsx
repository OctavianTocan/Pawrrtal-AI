...
import { flattenLabels, type LabelConfig } from '@/lib/craft-shared/labels'
import type { PermissionMode } from '@/lib/craft-shared/agent/mode-types'
import type { SessionStatus } from '@/config/session-status-config'
import type { BackgroundTask } from '@/components/shell/ActiveTasksBar'
import { ActiveOptionBadges } from '@/components/shell/ActiveOptionBadges'
