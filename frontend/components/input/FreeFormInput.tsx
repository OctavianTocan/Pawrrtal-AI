...
import { Icon_Home, Icon_Folder, Spinner } from '@/components/craft-ui'

import * as storage from '@/lib/local-storage'
import { useDirectoryPicker } from '@/hooks/useDirectoryPicker'
import { ServerDirectoryBrowser } from '@/components/ServerDirectoryBrowser'
import { extractWorkspaceSlugFromPath } from '@/lib/craft-shared/utils/workspace-slug'
...
import type { LabelConfig } from '@/lib/craft-shared/labels'
import { parseMentions } from '@/lib/mentions'
import { RichTextInput, type RichTextInputHandle } from '@/components/ui/rich-text-input'
import { Tooltip, TooltipContent, TooltipTrigger } from '@/components/craft-ui'
import {
  DropdownMenu,
  DropdownMenuTrigger,
  DropdownMenuSub,
...
import { AttachmentPreview } from '@/components/shell/AttachmentPreview'
import { ANTHROPIC_MODELS, getModelShortName, getModelDisplayName, getModelContextWindow, type ModelDefinition } from '@/lib/craft-shared/config/models'
import { resolveEffectiveConnectionSlug, isCompatProvider } from '@/lib/craft-shared/config/llm-connections'
...
import type { FileAttachment, LoadedSource, LoadedSkill } from '@/lib/craft-shared/types'
import type { PermissionMode } from '@/lib/craft-shared/agent/mode-types'
import { type ThinkingLevel, THINKING_LEVELS, getThinkingLevelName } from '@/lib/craft-shared/agent/thinking-levels'
import { useEscapeInterrupt } from '@/context/EscapeInterruptContext'
import { hasOpenOverlay } from '@/lib/overlay-detection'
import { ToolbarStatusSlot } from './ToolbarStatusSlot'
import { buildPlanApprovalMessage } from '@/components/shell/plan-approval-message'
...
export function FreeFormInput({
  ...
  const sourceButtonRef = React.useRef<HTMLButtonElement>(null) as React.RefObject<HTMLButtonElement>
