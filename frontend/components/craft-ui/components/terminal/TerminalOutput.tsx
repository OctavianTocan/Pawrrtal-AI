...
export function TerminalOutput({
	...
	const copyToClipboard = useCallback(
		async (text: string, type: "command" | "output") => {
			try {
	...
	return (
		<div
			className={cn(
				"h-full w-full overflow-auto px-5 py-4 font-mono text-sm",
				className,
			)}
		...
		>
			...
			<div>
								...
								style={{
									backgroundColor:
										exitCode === 0
											...
											: "rgba(239, 68, 68, 0.2)",
									color:
										exitCode === 0 ? "rgb(34, 197, 94)" : "rgb(239, 68, 68)",
								}}
							>
								exit {exitCode}
							</span>
				...
				<pre className="overflow-auto" style={{ color: textColor }}>
