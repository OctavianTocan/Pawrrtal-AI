		...
		return (
			<div className={cn("space-y-3", className)}>
				...
				<div className="flex items-center gap-2">
					...
					<span
						className={cn("text-foreground font-medium", SIZE_CONFIG.fontSize)}
					>
						Done
					</span>
				</div>
				...
				{result && (
					<div
						className={cn(
							"text-muted-foreground leading-relaxed prose-compact",
							SIZE_CONFIG.fontSize,
						)}
					>
	...
	return (
		<div className={cn("space-y-3", className)}>
			...
			{error && (
				<div
					className={cn(
						"text-destructive/80 leading-relaxed prose-compact",
						SIZE_CONFIG.fontSize,
					)}
				>
