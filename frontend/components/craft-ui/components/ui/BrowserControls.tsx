...
const SAFE_CSS_COLOR_RE =
	/^(#[0-9a-f]{3,8}|(?:rgba?|hsla?|oklch|oklab|lch|lab|color)\([^;{}]*\))$/i;
					...
					style={
						safeThemeColor
							? {
									...
									...(isFocused
										? { boxShadow: "0 0 0 1.5px var(--tb-focus-ring)" }
										: {}),
								}
							: undefined
					}
				...
				<span className="absolute inset-y-0 left-3 flex items-center justify-center">
					{loading ? (
						<span
							...
							style={
								safeThemeColor
									? { color: isFocused ? "var(--tb-fg)" : "var(--tb-fg-muted)" }
									: undefined
							}
						>
	...
	return (
		<div
			className={cn(
				...
				compact
					? "h-[40px] px-2"
					: "h-[48px] border-b border-foreground/6 px-3",
				className,
			)}
					...
					...(safeThemeColor
						? {
								...
								"--tb-fg": isDarkBg
									...
									: "rgba(0,0,0,0.7)",
								"--tb-fg-muted": isDarkBg
									? "rgba(255,255,255,0.4)"
									: "rgba(0,0,0,0.35)",
								"--tb-hover": isDarkBg
									? "rgba(255,255,255,0.1)"
									: "rgba(0,0,0,0.06)",
								"--tb-input-border": isDarkBg
									? "rgba(255,255,255,0.12)"
									: "rgba(0,0,0,0.06)",
								"--tb-focus-ring": isDarkBg
        ...
        `,
			...
			>
				<ChevronLeft
					...
					style={safeThemeColor ? { color: "inherit" } : undefined}
					strokeWidth={1.5}
				/>
			</NavButton>
			<NavButton
			...
			<div className="flex-1 flex items-center min-w-0">
				<div
					className={cn(
						"mx-auto flex items-center gap-1 w-full",
						urlBarClassName,
					)}
				>
					{reloadButton}
