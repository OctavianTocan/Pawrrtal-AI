...
function TiptapImageNodeView({
	node,
	editor,
	getPos,
	updateAttributes,
}: TiptapImageNodeViewProps) {
	...
	const captureIntrinsicDimensions = React.useCallback(
	...
	return (
		...
		>
			...
			>
				{!loaded && !failed && (
					<div className="tiptap-image-placeholder" aria-hidden="true" />
				)}
				<img
					ref={imageRef}
					src={src}
