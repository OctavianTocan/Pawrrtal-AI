...
export function MarkdownMermaidBlock({
	...
	const needsScaling =
		scaledDims && (scaledDims.width != null || scaledDims.scale !== 1);
                ...
                transform-origin: top left ensures scaling expands down and right. */}
						<div
							...
							style={{
								...
								transform:
									scaledDims && scaledDims.scale !== 1
										? `scale(${scaledDims.scale})`
										: undefined,
							}}
						/>
					</div>
