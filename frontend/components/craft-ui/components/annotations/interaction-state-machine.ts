	...
	switch (action.type) {
		...
		case "OPEN_FROM_SELECTION":
			return {
				...
				followUpDraft: "",
				selectionMenuAnchor: {
					x: action.selection.anchorX,
					y: action.selection.anchorY,
				},
			};
		...
		case "OPEN_FROM_ANNOTATION":
			return {
				...
				selectionMenuAnchor: {
					x: action.detail.anchorX,
					y: action.detail.anchorY,
				},
			};
		...
		case "CANCEL_FOLLOW_UP": {
			if (state.pendingSelection) {
				return {
					...
					activeAnnotationDetail: null,
					selectionMenuAnchor: {
						x: state.pendingSelection.anchorX,
						y: state.pendingSelection.anchorY,
					},
				};
			}
