...
export function clampIslandAnchorX(
	anchorX: number,
	islandWidth: number,
): number {
...
export function buildSelectionEntryTransition(
	from: PointerSnapshot | null,
	to: PointerSnapshot | null,
	...
	return {
		...
		entryDistancePx: Number.isFinite(derivedDistancePx)
			? derivedDistancePx
			: FALLBACK_ENTRY_DISTANCE,
		entryStartScale: DEFAULT_START_SCALE,
	};
}
