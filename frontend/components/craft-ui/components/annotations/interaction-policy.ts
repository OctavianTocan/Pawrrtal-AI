 ...
 */
export function getAnnotationChipInteraction(
	annotation?: AnnotationV1 | null,
): AnnotationChipInteraction {
...
export function isAnnotationChipClickable(
	annotation?: AnnotationV1 | null,
): boolean {
 ...
 */
export function shouldIgnoreSelectionMouseUpTarget(
