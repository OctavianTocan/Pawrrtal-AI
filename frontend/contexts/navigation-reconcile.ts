import { buildRouteFromNavigationState, parseRouteToNavigationState } from '@/lib/craft-shared/route-parser'
import type { ViewRoute } from '@/lib/craft-shared/routes'
import type { NavigationState } from '@/lib/craft-shared/types'
