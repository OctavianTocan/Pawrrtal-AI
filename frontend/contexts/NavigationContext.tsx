...
import {
  ...
  type ParsedRoute,
} from '@/lib/craft-shared/route-parser'
import { routes, type Route, type ViewRoute } from '@/lib/craft-shared/routes'
import { parsePermissionMode } from '@/lib/craft-shared/agent/mode-types'
...
import { isValidSettingsSubpage, type SettingsSubpage } from '@/lib/craft-shared/settings-registry'
...
interface NavigationProviderProps {
  ...
  onCreateSession: (workspaceId: string, options?: import('@/lib/craft-shared/types').CreateSessionOptions) => Promise<Session>
...
export function NavigationProvider({
  ...
  const handleActionNavigation = useCallback(
    async (parsed: ParsedRoute, options?: { newPanel?: boolean; targetLaneId?: 'main' }) => {
      ...
      switch (parsed.name) {
        case 'new-session': {
          const createOptions: import('@/lib/craft-shared/types').CreateSessionOptions = {}
          ...
          const filter: import('@/lib/craft-shared/types').SessionFilter =
