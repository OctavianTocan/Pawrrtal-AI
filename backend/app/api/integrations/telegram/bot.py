...
handlers in :mod:`app.api.integrations.telegram.handlers`. Two boot modes:
...
from app.api.integrations.telegram.bot_permissions import build_telegram_permission_check
